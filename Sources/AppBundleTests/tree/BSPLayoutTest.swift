...
class BSPLayoutTest: XCTestCase {
    ...
    func testChooseBSPSplitDirection_ThresholdBoundary() {
        ...
        let container = createTestContainer()
        let _ = config.bsp.autoSplitThreshold
    ...
    func testMoveCommand_BSP_MoveOutOfContainer_ShouldMoveCorrectly() async throws {
        ...
        // And: Left container should now have only one child
        XCTAssertEqual(leftContainer.children.count, 1, "Left container should have one child")
        XCTAssertTrue(leftContainer.children.contains(topLeftWindow), "Left container should contain top left window")
    }
    ...
    func testSafeTransitionToBSP_ValidTransition_ShouldSucceed() throws {
        ...
        let _ = TestWindow.new(id: 1, parent: container, adaptiveWeight: 1.0)
    ...
    func testHandleBSPError_SplitFailed_ShouldAttemptRecovery() {
        ...
        let container = createTestContainer()
        container.layout = .bsp
        let _ = TestWindow.new(id: 1, parent: container, adaptiveWeight: 0.0) // Invalid weight
    ...
    func testResizeCommand_BSP_HorizontalSplit_ShouldAdjustWeights() async throws {
        ...
        XCTAssertEqual(window1.getWeight(.h), 70, accuracy: 0.001, "Window1 should have increased weight")
        XCTAssertEqual(window2.getWeight(.h), 30, accuracy: 0.001, "Window2 should have decreased weight")
    ...
    func testResizeCommand_BSP_VerticalSplit_ShouldAdjustWeights() async throws {
        ...
        XCTAssertEqual(window2.getWeight(.v), 0.3, accuracy: 0.001, "Window2 should have decreased weight")
        XCTAssertEqual(window1.getWeight(.v), 0.7, accuracy: 0.001, "Window1 should have increased weight")
    }
    ...
    func testResizeCommand_BSP_SmartResize_ShouldUseContainerOrientation() async throws {
        ...
        XCTAssertEqual(window1.getWeight(.h), 0.8, accuracy: 0.001, "Window1 should have set weight")
        XCTAssertEqual(window2.getWeight(.h), 0.2, accuracy: 0.001, "Window2 should have adjusted weight")
    }
    ...
    func testResizeCommand_BSP_SmartOppositeResize_ShouldUseOppositeOrientation() async throws {
        ...
        XCTAssertEqual(nestedContainer.getWeight(.h), 0.7, accuracy: 0.001, "Nested container should have increased weight")
        XCTAssertEqual(window3.getWeight(.h), 0.3, accuracy: 0.001, "Window3 should have decreased weight")
    }
    ...
    func testResizeCommand_BSP_MultipleWindows_ShouldDistributeWeightEvenly() async throws {
        ...
        XCTAssertEqual(window2.getWeight(.h), 0.6, accuracy: 0.001, "Window2 should have increased weight")
        XCTAssertEqual(window1.getWeight(.h), 0.2, accuracy: 0.001, "Window1 should have decreased weight")
        XCTAssertEqual(window3.getWeight(.h), 0.2, accuracy: 0.001, "Window3 should have decreased weight")
    ...
    func testResizeCommand_BSP_NestedContainers_ShouldResizeCorrectLevel() async throws {
        ...
        XCTAssertEqual(window1.getWeight(.v), 0.5, accuracy: 0.001, "Window1 should have decreased weight")
        XCTAssertEqual(window2.getWeight(.v), 0.5, accuracy: 0.001, "Window2 should have increased weight")
